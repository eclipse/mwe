...
import static org.eclipse.emf.mwe.releng.util.Helper.delete;
...
public class GetNonIpApprovedJars {
	...
	public static void main(String[] args) throws Exception {
		new GetNonIpApprovedJars().downloadAndPlaceJars();
	}
	 ...
	 * 
	 */
	public void downloadAndPlaceJars() throws Exception {
		try {
