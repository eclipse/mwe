...
public class Mwe2Lexer extends Lexer {
    ...
    public final void mColon() throws RecognitionException {
        try {
            int _type = Colon;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../org.eclipse.emf.mwe2.language/src/org/eclipse/emf/mwe2/language/lexer/Mwe2Lexer.g:52:7: ({...}? => ':' )
            // ../org.eclipse.emf.mwe2.language/src/org/eclipse/emf/mwe2/language/lexer/Mwe2Lexer.g:52:9: {...}? => ':'
            {
            if ( !((!singleQuotedString && !doubleQuotedString || stringVariable)) ) {
    ...
    public final void mCommercialAt() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../org.eclipse.emf.mwe2.language/src/org/eclipse/emf/mwe2/language/lexer/Mwe2Lexer.g:56:14: ({...}? => '@' )
            // ../org.eclipse.emf.mwe2.language/src/org/eclipse/emf/mwe2/language/lexer/Mwe2Lexer.g:56:16: {...}? => '@'
            {
            if ( !((!singleQuotedString && !doubleQuotedString || stringVariable)) ) {
    ...
    public final void mLeftCurlyBracket() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../org.eclipse.emf.mwe2.language/src/org/eclipse/emf/mwe2/language/lexer/Mwe2Lexer.g:58:18: ({...}? => '{' )
            // ../org.eclipse.emf.mwe2.language/src/org/eclipse/emf/mwe2/language/lexer/Mwe2Lexer.g:58:20: {...}? => '{'
            {
            if ( !((!singleQuotedString && !doubleQuotedString || stringVariable)) ) {
    ...
    public final void mRightCurlyBracket() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../org.eclipse.emf.mwe2.language/src/org/eclipse/emf/mwe2/language/lexer/Mwe2Lexer.g:60:19: ({...}? => '}' )
            // ../org.eclipse.emf.mwe2.language/src/org/eclipse/emf/mwe2/language/lexer/Mwe2Lexer.g:60:21: {...}? => '}'
            {
            if ( !((!singleQuotedString && !doubleQuotedString || stringVariable)) ) {
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../org.eclipse.emf.mwe2.language/src/org/eclipse/emf/mwe2/language/lexer/Mwe2Lexer.g:64:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // ../org.eclipse.emf.mwe2.language/src/org/eclipse/emf/mwe2/language/lexer/Mwe2Lexer.g:64:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // ../org.eclipse.emf.mwe2.language/src/org/eclipse/emf/mwe2/language/lexer/Mwe2Lexer.g:64:11: ( '^' )?
            int alt1=2;
            ...
            // ../org.eclipse.emf.mwe2.language/src/org/eclipse/emf/mwe2/language/lexer/Mwe2Lexer.g:64:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop2:
            do {
                int alt2=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../org.eclipse.emf.mwe2.language/src/org/eclipse/emf/mwe2/language/lexer/Mwe2Lexer.g:66:10: ({...}? => ( '0' .. '9' )+ )
            // ../org.eclipse.emf.mwe2.language/src/org/eclipse/emf/mwe2/language/lexer/Mwe2Lexer.g:66:12: {...}? => ( '0' .. '9' )+
            {
            if ( !((!singleQuotedString && !doubleQuotedString || stringVariable)) ) {
                throw new FailedPredicateException(input, "RULE_INT", "!singleQuotedString && !doubleQuotedString || stringVariable");
            }
            // ../org.eclipse.emf.mwe2.language/src/org/eclipse/emf/mwe2/language/lexer/Mwe2Lexer.g:66:78: ( '0' .. '9' )+
            int cnt3=0;
            loop3:
            do {
                int alt3=2;
                ...
                switch (alt3) {
            	case 1 :
            	    // ../org.eclipse.emf.mwe2.language/src/org/eclipse/emf/mwe2/language/lexer/Mwe2Lexer.g:66:79: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../org.eclipse.emf.mwe2.language/src/org/eclipse/emf/mwe2/language/lexer/Mwe2Lexer.g:68:17: ({...}? => ( '/*' ( options {greedy=false; } : . )* '*/' ) )
            // ../org.eclipse.emf.mwe2.language/src/org/eclipse/emf/mwe2/language/lexer/Mwe2Lexer.g:68:19: {...}? => ( '/*' ( options {greedy=false; } : . )* '*/' )
            {
            if ( !((!singleQuotedString && !doubleQuotedString || stringVariable)) ) {
                throw new FailedPredicateException(input, "RULE_ML_COMMENT", "!singleQuotedString && !doubleQuotedString || stringVariable");
            }
            // ../org.eclipse.emf.mwe2.language/src/org/eclipse/emf/mwe2/language/lexer/Mwe2Lexer.g:68:85: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // ../org.eclipse.emf.mwe2.language/src/org/eclipse/emf/mwe2/language/lexer/Mwe2Lexer.g:68:86: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // ../org.eclipse.emf.mwe2.language/src/org/eclipse/emf/mwe2/language/lexer/Mwe2Lexer.g:68:91: ( options {greedy=false; } : . )*
            loop4:
            do {
                int alt4=2;
                ...
                switch (alt4) {
            	case 1 :
            	    // ../org.eclipse.emf.mwe2.language/src/org/eclipse/emf/mwe2/language/lexer/Mwe2Lexer.g:68:119: .
            	    {
            	    matchAny(); 
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../org.eclipse.emf.mwe2.language/src/org/eclipse/emf/mwe2/language/lexer/Mwe2Lexer.g:70:17: ({...}? => ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? ) )
            // ../org.eclipse.emf.mwe2.language/src/org/eclipse/emf/mwe2/language/lexer/Mwe2Lexer.g:70:19: {...}? => ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            {
            if ( !((!singleQuotedString && !doubleQuotedString || stringVariable)) ) {
                throw new FailedPredicateException(input, "RULE_SL_COMMENT", "!singleQuotedString && !doubleQuotedString || stringVariable");
            }
            // ../org.eclipse.emf.mwe2.language/src/org/eclipse/emf/mwe2/language/lexer/Mwe2Lexer.g:70:85: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // ../org.eclipse.emf.mwe2.language/src/org/eclipse/emf/mwe2/language/lexer/Mwe2Lexer.g:70:86: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // ../org.eclipse.emf.mwe2.language/src/org/eclipse/emf/mwe2/language/lexer/Mwe2Lexer.g:70:91: (~ ( ( '\\n' | '\\r' ) ) )*
            loop5:
            do {
                int alt5=2;
            ...
            // ../org.eclipse.emf.mwe2.language/src/org/eclipse/emf/mwe2/language/lexer/Mwe2Lexer.g:70:107: ( ( '\\r' )? '\\n' )?
            int alt7=2;
            ...
            switch (alt7) {
                case 1 :
                    // ../org.eclipse.emf.mwe2.language/src/org/eclipse/emf/mwe2/language/lexer/Mwe2Lexer.g:70:108: ( '\\r' )? '\\n'
                    {
                    // ../org.eclipse.emf.mwe2.language/src/org/eclipse/emf/mwe2/language/lexer/Mwe2Lexer.g:70:108: ( '\\r' )?
                    int alt6=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../org.eclipse.emf.mwe2.language/src/org/eclipse/emf/mwe2/language/lexer/Mwe2Lexer.g:72:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // ../org.eclipse.emf.mwe2.language/src/org/eclipse/emf/mwe2/language/lexer/Mwe2Lexer.g:72:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // ../org.eclipse.emf.mwe2.language/src/org/eclipse/emf/mwe2/language/lexer/Mwe2Lexer.g:72:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt8=0;
            loop8:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../org.eclipse.emf.mwe2.language/src/org/eclipse/emf/mwe2/language/lexer/Mwe2Lexer.g:74:16: ( . )
            // ../org.eclipse.emf.mwe2.language/src/org/eclipse/emf/mwe2/language/lexer/Mwe2Lexer.g:74:18: .
            {
            matchAny(); 
    ...
    public void mTokens() throws RecognitionException {
        ...
        switch (alt9) {
            ...
            case 15 :
                ...
                break;
            case 16 :
                // ../org.eclipse.emf.mwe2.language/src/org/eclipse/emf/mwe2/language/lexer/Mwe2Lexer.g:1:247: FullStop
                {
                mFullStop(); 
                ...
                break;
            case 17 :
                // ../org.eclipse.emf.mwe2.language/src/org/eclipse/emf/mwe2/language/lexer/Mwe2Lexer.g:1:256: Colon
                {
                mColon(); 
                ...
                break;
            case 18 :
                // ../org.eclipse.emf.mwe2.language/src/org/eclipse/emf/mwe2/language/lexer/Mwe2Lexer.g:1:262: EqualsSign
                {
                mEqualsSign(); 
                ...
                break;
            case 19 :
                // ../org.eclipse.emf.mwe2.language/src/org/eclipse/emf/mwe2/language/lexer/Mwe2Lexer.g:1:273: CommercialAt
                {
                mCommercialAt(); 
                ...
                break;
            case 20 :
                // ../org.eclipse.emf.mwe2.language/src/org/eclipse/emf/mwe2/language/lexer/Mwe2Lexer.g:1:286: LeftCurlyBracket
                {
                mLeftCurlyBracket(); 
                ...
                break;
            case 21 :
                // ../org.eclipse.emf.mwe2.language/src/org/eclipse/emf/mwe2/language/lexer/Mwe2Lexer.g:1:303: RightCurlyBracket
                {
                mRightCurlyBracket(); 
                ...
                break;
            case 22 :
                // ../org.eclipse.emf.mwe2.language/src/org/eclipse/emf/mwe2/language/lexer/Mwe2Lexer.g:1:321: RULE_ID
                {
                mRULE_ID(); 
                ...
                break;
            case 23 :
                // ../org.eclipse.emf.mwe2.language/src/org/eclipse/emf/mwe2/language/lexer/Mwe2Lexer.g:1:329: RULE_INT
                {
                mRULE_INT(); 
                ...
                break;
            case 24 :
                // ../org.eclipse.emf.mwe2.language/src/org/eclipse/emf/mwe2/language/lexer/Mwe2Lexer.g:1:338: RULE_ML_COMMENT
                {
                mRULE_ML_COMMENT(); 
                ...
                break;
            case 25 :
                // ../org.eclipse.emf.mwe2.language/src/org/eclipse/emf/mwe2/language/lexer/Mwe2Lexer.g:1:354: RULE_SL_COMMENT
                {
                mRULE_SL_COMMENT(); 
                ...
                break;
            case 26 :
                // ../org.eclipse.emf.mwe2.language/src/org/eclipse/emf/mwe2/language/lexer/Mwe2Lexer.g:1:370: RULE_WS
                {
                mRULE_WS(); 
                ...
                break;
            case 27 :
                // ../org.eclipse.emf.mwe2.language/src/org/eclipse/emf/mwe2/language/lexer/Mwe2Lexer.g:1:378: RULE_ANY_OTHER
                {
                mRULE_ANY_OTHER(); 
