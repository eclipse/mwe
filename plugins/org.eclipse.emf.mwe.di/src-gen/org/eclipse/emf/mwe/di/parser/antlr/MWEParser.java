...
public class MWEParser extends org.eclipse.xtext.parser.antlr.AbstractAntlrParser {
	...
	protected IParseResult parse(String ruleName, ANTLRInputStream in) {
		org.eclipse.emf.mwe.di.parser.antlr.internal.InternalMWELexer lexer = new org.eclipse.emf.mwe.di.parser.antlr.internal.InternalMWELexer(in);
		XtextTokenStream stream = new XtextTokenStream(lexer, antlrTokenDefProvider);
		stream.setInitialHiddenTokens("RULE_WS", "RULE_ML_COMMENT", "RULE_SL_COMMENT");
		org.eclipse.emf.mwe.di.parser.antlr.internal.InternalMWEParser parser = new org.eclipse.emf.mwe.di.parser.antlr.internal.InternalMWEParser(
