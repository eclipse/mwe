...
public final class MWEPropertyConsumer extends NonTerminalConsumer {
	...
	protected class RuleCall$2$Consumer extends ElementConsumer<RuleCall> {
		...
		protected int doConsume() throws Exception {
			return consumeNonTerminal(localVariableConsumer, null, false, false, false, getElement());
		}
	}
	...
	protected class RuleCall$3$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume() throws Exception {
			return consumeNonTerminal(propertiesFileImportConsumer, null, false, false, false, getElement());
		}
	}
	...
	public void setRule(PropertyElements rule) {
		...
		ruleCall$2$Consumer = new RuleCall$2$Consumer(rule.ele0ParserRuleCallLocalVariable());
		ruleCall$3$Consumer = new RuleCall$3$Consumer(rule.ele1ParserRuleCallPropertiesFileImport());
	}
