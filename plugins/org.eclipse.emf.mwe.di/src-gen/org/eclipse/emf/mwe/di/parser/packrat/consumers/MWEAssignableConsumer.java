...
public final class MWEAssignableConsumer extends NonTerminalConsumer {
	...
	private AssignableElements rule;	
	...
	public void setRule(AssignableElements rule) {
		this.rule = rule;
		
		alternatives$1$Consumer = new Alternatives$1$Consumer(rule.eleAlternatives());
		ruleCall$2$Consumer = new RuleCall$2$Consumer(rule.ele0ParserRuleCallComplexValue());
		ruleCall$3$Consumer = new RuleCall$3$Consumer(rule.ele1ParserRuleCallWorkflowRef());
	}
