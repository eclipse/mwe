 ...
 * </copyright>
 *
 * $Id: WorkflowPredicateOR.java,v 1.1 2009/05/14 04:12:29 bhunt Exp $
 */
...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Workflow Predicate OR</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 *   <li>{@link org.eclipse.emf.mwe.ewm.workflow.orchestration.WorkflowPredicateOR#getConditions <em>Conditions</em>}</li>
 * </ul>
 * </p>
 *
 ...
 * @generated
 */
public class WorkflowPredicateOR extends WorkflowExecutionPredicate
{
	/**
	...
	{
		return OrchestrationPackage.Literals.WORKFLOW_PREDICATE_OR;
	}
	 ...
	 * @see org.eclipse.emf.mwe.ewm.workflow.orchestration.OrchestrationPackage#getWorkflowPredicateOR_Conditions()
	...
	public EList<WorkflowExecutionPredicate> getConditions()
	{
		if (conditions == null)
		{
			conditions = new EObjectContainmentEList<WorkflowExecutionPredicate>(WorkflowExecutionPredicate.class, this, OrchestrationPackage.WORKFLOW_PREDICATE_OR__CONDITIONS);
		}
		return conditions;
	}
