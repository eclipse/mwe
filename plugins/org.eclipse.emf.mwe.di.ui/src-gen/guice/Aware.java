...
public class Aware implements IExecutableExtensionFactory, IExecutableExtension {
	...
	public Object create() throws CoreException {
		Bundle bundle = org.eclipse.emf.mwe.di.ui.internal.MWEActivator.getInstance().getBundle();
		try {
			Class<?> class1 = bundle.loadClass(clazzName);
			return org.eclipse.emf.mwe.di.ui.internal.MWEActivator.getInstance().getInjector().getInstance(class1);
		}
		catch (Exception e) {
			log.error(e);
