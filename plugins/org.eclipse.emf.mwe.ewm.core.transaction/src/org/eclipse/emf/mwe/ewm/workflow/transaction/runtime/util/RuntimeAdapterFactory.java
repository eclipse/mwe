...
public class RuntimeAdapterFactory extends AdapterFactoryImpl
{
	...
	protected RuntimeSwitch<Adapter> modelSwitch =
		...
		{
			@Override
			public Adapter caseWorkflowTransactionalContext(WorkflowTransactionalContext object)
			{
				return createWorkflowTransactionalContextAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.mwe.ewm.workflow.transaction.runtime.WorkflowTransactionalContext <em>Workflow Transactional Context</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createWorkflowTransactionalContextAdapter()
	{
		return null;
	}
