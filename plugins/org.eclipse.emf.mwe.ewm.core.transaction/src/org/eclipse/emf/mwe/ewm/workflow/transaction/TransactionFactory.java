 ...
 * <!-- end-user-doc -->
 * @see org.eclipse.emf.mwe.ewm.workflow.transaction.TransactionPackage
 * @generated
 */
public class TransactionFactory extends EFactoryImpl
{
	/**
	 ...
	 * @generated
	 */
	public static final TransactionFactory eINSTANCE = init();
	...
	public static TransactionFactory init()
	{
		try
		{
			TransactionFactory theTransactionFactory = (TransactionFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.eclipse.org/emf/mwe/ewm/workflow/transaction"); 
	...
	public Object createFromString(EDataType eDataType, String initialValue)
	{
		...
		{
			case TransactionPackage.TRANSACTIONAL_EDITING_DOMAIN:
