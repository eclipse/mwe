 ...
 *
 */
public class WorkflowLogInfoCommand extends WorkflowBaseLogCommand
{
	public WorkflowLogInfoCommand(WorkflowTransactionalContext context, WorkflowComponent component, String message)
	{
