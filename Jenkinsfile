    ...
    try {
        ...
        try {
            wrap([$class:'Xvnc', useXauthority: true]) {
                sh "cd maven; ${mvnHome}/bin/mvn  -f org.eclipse.emf.mwe2.parent/pom.xml --batch-mode --update-snapshots -fae -Dmaven.repo.local=${workspace}/.m2/repository -Dtycho.localArtifacts=ignore clean install"
            }
        } finally {
